...
public class MainMenuFrame extends ZooFrame {
	...
	public MainMenuFrame(String title) {
		...
		btnAdd.setToolTipText("What be you waitin' for!?");
		pan.add(btnAdd);
		...
		btnList.setToolTipText("Honorary crew members! It ain't much, but it's ours!");
		pan.add(btnList);
		...
		btnSaveAndExit.setToolTipText("Avast!");
